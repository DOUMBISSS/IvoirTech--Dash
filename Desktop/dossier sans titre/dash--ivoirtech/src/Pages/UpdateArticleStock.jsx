...
export default function UpdateArticleStock() {
        ...
        <div className="dashboard">
          ...
          <div className="right">
            <div className="firstly">
              <h1 className='header__title'><i className="fa-solid fa-pen"></i> Mettre a jour l'article </h1>
                      ...
                      <form className="row g-3">
                                    ...
                                    <div className="col-md-3">
                                        <label htmlFor="validationDefault02" className="form-label">N° Serie</label>
                                        <input type="text" className="form-control" id="validationDefault02" required/>
                                    </div>
