        ...
        <div className="dashboard">
          ...
          <div className="sidebar">
                                ...
                                <div className="sidebar--item">
                                    <Link to='/Accueil' className="link__sidebar"><p>Téléphone</p></Link>
                                </div>
                                <div className="sidebar--item">
                                    <Link to='/persons' className="link__sidebar"><p>Laptop</p></Link>
                                </div>
                                <div className="sidebar--item">
                                    <Link to='/renthome' className="link__sidebar"><p><i class="fa-solid fa-house"></i> Ecran Bureau</p></Link>
                                </div>
                                <h6>Marques</h6>
                                <div className="sidebar--item">
                                    <Link to='/Accueil' className="link__sidebar"><p>Téléphone</p></Link>
